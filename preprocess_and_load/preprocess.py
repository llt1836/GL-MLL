...
def train_set():
    ...
    trainSet.to_csv(opt.train_data_list, header=False, index=False, sep=' ')
...
def val_test_set():
    ...
    validSet.to_csv(opt.valid_data_list, header=False, index=False, sep=' ')
    testSet.to_csv(opt.test_data_list, header=False, index=False, sep=' ')
